...
const PrintAbsensi = ({ initTahun, initBulan }) => {
    ...
    return (
        <>
            ...
            <div className="bg-emerald-200 border-b-2 border-emerald-500 text-lg text-center text-slate-600 font-bold uppercase mb-2">print absensi</div>
            ...
            <PrintLink label='print semua' href={route('print-absensi.print-semua', { tahun: data.tahun, bulan: data.bulan })} />
        </>
    )
}
